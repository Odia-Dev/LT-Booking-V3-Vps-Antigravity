  ...
  if (!token) {
    return (
      <div className="w-full max-w-md bg-neutral-900/40 border border-neutral-800/80 rounded-2xl p-8 backdrop-blur-md shadow-2xl text-center">
        ...
        <p className="text-sm text-neutral-400 mb-6">No reset token provided.</p>
        <Link href="/forgot-password" className="px-6 py-3 bg-white text-neutral-950 font-bold rounded-lg hover:bg-neutral-200 transition-colors">
          Request New Link
        </Link>
      </div>
    );
