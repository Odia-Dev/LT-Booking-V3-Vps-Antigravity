      ...
      {bookings.length === 0 ? (
        ...
        <div className="space-y-6">
          {bookings.map((booking) => (
            <div
              key={booking.id}
              className="bg-neutral-900/20 border border-neutral-850 rounded-2xl p-6 shadow-xl hover:border-neutral-700/60 transition-colors flex flex-col justify-between"
            >
              <div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-neutral-850 pb-4 mb-4">
                  <div>
                    ...
                    <Link
                      ...
                      className="text-base font-bold text-white font-mono hover:text-[#eb0a1e] transition-colors flex items-center gap-1 group"
                    >
              ...
              <div className="mt-6 pt-4 border-t border-neutral-850/60 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-xs text-neutral-400">
                <div className="grid grid-cols-1 gap-2">
                  {booking.assignedExecutive && (
                    <div>
                      ...
                      <span className="text-neutral-200">{booking.assignedExecutive}</span>
                    </div>
                  )}
                  {booking.notes && (
                    <div>
                ...
                <Link
                  href={`/dashboard/bookings/${booking.id}`}
                  className="px-4 py-2 border border-neutral-800 hover:border-neutral-600 hover:bg-neutral-900 text-neutral-300 hover:text-white rounded-lg transition-all font-semibold tracking-wide uppercase text-[11px]"
                >
